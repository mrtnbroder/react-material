...
const light = {
  ...
  text: {
    ...darkText,
    headline1: darkText.secondary,
    headline2: darkText.secondary,
    headline3: darkText.secondary,
    headline4: darkText.secondary,
    headline: darkText.primary,
    title: darkText.primary,
    subtitle2: darkText.primary,
    subtitle1: darkText.primary,
...
const dark = {
  ...
  text: {
    ...lightText,
    headline1: lightText.primary,
    headline2: lightText.primary,
    headline3: lightText.primary,
    headline4: lightText.primary,
    headline: lightText.primary,
    title: lightText.primary,
    subtitle2: lightText.primary,
    subtitle1: lightText.primary,
